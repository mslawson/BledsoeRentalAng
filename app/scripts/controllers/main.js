 ...
 */
 ...
 app.controller('CarouselDemoCtrl', function ($scope) {
  ...
  var slides = $scope.slides = [
    { image: "images/banner/bounce-banner/ban-pc.jpg",
      text: "The Royal Princess Carriage - $255 A Day!" },
    { image: "images/banner/bounce-banner/ban-fs.jpg",
      text: "The Fire Station Combo Bounce House - $255 A Day"},
    { image: "images/banner/bounce-banner/ban-tiger.jpg",
      text:  "The Tiger Belly Bounce House - $153 A Day"},
    { image: "images/banner/bounce-banner/ban-cas.jpg", 
      text:  "The Castle Bounce House - $153 A Day",
 ...
 app.controller('minibouncerModal', function ($scope, $modal, $log) {
  ...
  $scope.open = function (size) {
    ...
    var modalInstance = $modal.open({
      animation: $scope.animationsEnabled,
      templateUrl: 'minibouncerModalContent.html',
      controller: 'ModalInstanceCtrl',
      size: size,
      resolve: {
        items: function () {
  ...
  app.controller('wackycastleModal', function ($scope, $modal, $log) {
  ...
  $scope.open = function (size) {
    ...
    var modalInstance = $modal.open({
      animation: $scope.animationsEnabled,
      templateUrl: 'wackycastleModalContent.html',
      controller: 'ModalInstanceCtrl',
      size: size,
      resolve: {
        items: function () {
 ...
 app.controller('princessModal', function ($scope, $modal, $log) {
  ...
  $scope.open = function (size) {
    ...
    var modalInstance = $modal.open({
      animation: $scope.animationsEnabled,
      templateUrl: 'princessModalContent.html',
      controller: 'ModalInstanceCtrl',
      size: size,
      resolve: {
        items: function () {
